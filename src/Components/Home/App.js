  ...
  return (
    ...
    <section className="text-[#001d28] bg-[#efeee9] h-3/4 ">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            ...
            <h1 className="text-[#001d28] tapered title-font sm:text-8xl text-5xl mb-4 font-medium ">Hey! <span className='text-[#001d28]'>I'm</span>
                <br className=" lg:inline-block "/> <span className='text-[#001d28]'>Varun</span> Sood
            </h1>
